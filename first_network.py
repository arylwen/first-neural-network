...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            #normalize the inputs to have the same dimensions 
            nX = np.array(X, ndmin=2).T
            ny = np.array(y, ndmin=2).T
            
            #### Implement the forward pass here ####
            ### Forward pass ###
            # TODO: Hidden layer - Replace these values with your calculations.
            hidden_inputs = np.dot(self.weights_input_to_hidden.T, nX) # signals into hidden layer
            ...
            error = ny-final_outputs # Output layer error is the difference between desired target and actual output.         
            ...
            delta_weights_i_h += hidden_error_term.T * nX
